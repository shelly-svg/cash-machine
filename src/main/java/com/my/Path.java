...
public final class Path {
    ...
    public static final String ADD_PRODUCT_PAGE = "/WEB-INF/jsp/commodity_expert/add_product.jsp";
    public static final String EDIT_PRODUCT_PAGE = "/WEB-INF/jsp/common/edit_product.jsp";
